	...
	private void initialize() {
		...
		frame.getContentPane().add(panel);
				...
				btnLoad.setToolTipText("Load");
						...
						lblTriangle.setIcon(new ImageIcon(PaintWindow.class.getResource("/paint/view/icons/icons8-trigonometry-26.png")));
						lblTriangle.setFont(new Font("Tahoma", Font.PLAIN, 16));
								...
								lblCircle.setFont(new Font("Tahoma", Font.PLAIN, 16));
										...
										lblSquare.setIcon(new ImageIcon(PaintWindow.class.getResource("/paint/view/icons/icons8-unchecked-checkbox-32.png")));
										lblSquare.setFont(new Font("Tahoma", Font.PLAIN, 16));
												...
												lblLine.setFont(new Font("Tahoma", Font.PLAIN, 16));
														...
														lblEllipse.setFont(new Font("Tahoma", Font.PLAIN, 16));
																...
																lblRectangle.setIcon(new ImageIcon(PaintWindow.class.getResource("/paint/view/icons/icons8-rectangular-32.png")));
																...
																lblRectangle.setFont(new Font("Tahoma", Font.PLAIN, 16));
																		...
																		lblUndo.setBounds(65, 373, 58, 58);
																		...
																		lblUndo.setFont(new Font("Tahoma", Font.PLAIN, 16));
																				...
																				lblRedo.setFont(new Font("Tahoma", Font.PLAIN, 16));
																						...
																						lblfillColor.setBounds(-6, 438, 69, 58);
																						lblfillColor.setToolTipText("Fill Color");
																						panel.add(lblfillColor);
																						lblfillColor.setBackground(new Color(255, 255, 255));
																						lblfillColor.setIcon(new ImageIcon(PaintWindow.class.getResource("/paint/view/icons/icons8-fill-color-64.png")));
																						...
																						lblStrokeColor.setBounds(65, 438, 58, 58);
																						lblStrokeColor.setToolTipText("Stroke Color");
																						panel.add(lblStrokeColor);
																						lblStrokeColor.setIcon(new ImageIcon(PaintWindow.class.getResource("/paint/view/icons/icons8-paint-palette-64.png")));
																						...
																						lblSelect.setBounds(31, 324, 70, 58);
																						...
																						lblSelect.setFont(new Font("Tahoma", Font.PLAIN, 16));
																								...
																								lblCopy.setBounds(73, 576, 64, 58);
																								...
																								lblCopy.setFont(new Font("Tahoma", Font.PLAIN, 16));
																										...
																										lblDeselect.setToolTipText("Deselect a shape");
																												...
																												lblMove.setFont(new Font("Tahoma", Font.PLAIN, 16));
																														...
																														lblResize.setBounds(65, 507, 58, 58);
																														...
																														lblResize.setFont(new Font("Tahoma", Font.PLAIN, 16));
																																...
																																lblDelete.setIcon(new ImageIcon(PaintWindow.class.getResource("/paint/view/icons/icons8-cancel-64.png")));
																																lblDelete.setBackground(new Color(255, 255, 255));
																																lblDelete.setBounds(2, 576, 71, 58);
																																...
																																lblDelete.setFont(new Font("Tahoma", Font.PLAIN, 16));
																																		...
																																		panel.add(lblNewLabel);
																																				...
																																				lbldeselectAll.setIcon(new ImageIcon(PaintWindow.class.getResource("/paint/view/icons/icons8-uncheck-all-50.png")));

...
public class LineSegment extends AbstractShape {
	...
	/*
	 * public void drawS(Object canvas) { Graphics2D g2D = (Graphics2D) canvas;
	 * float dash1[] = {10.0f}; BasicStroke dashed = new BasicStroke(3.0f,
	 * BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, dash1, 0.0f);
	 * 
	 * g2D.setStroke(dashed); g2D.setColor(this.getColor());
	 * g2D.drawLine(this.getPosition().x , this.getPosition().y
	 * ,this.getProperties().get("EndPositionX").intValue(),this.getProperties().get
	 * ("EndPositionY").intValue());
	 * 
	 * 
	 * }
	 */

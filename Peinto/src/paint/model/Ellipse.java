...
public class Ellipse extends AbstractShape {
	...
	public boolean contains(double xx, double yy)
	{
		...
		Ellipse2D oval2D = new Ellipse2D.Double( x,y, this.getProperties().get("Width"), this.getProperties().get("Height"));
	...
	public void drawS(Object canvas)
	{
		...
		g2D.setColor(this.getColor());
		g2D.drawOval(x,y, this.getProperties().get("Width").intValue(), this.getProperties().get("Height").intValue());
		g2D.setColor(this.getFillColor());
		g2D.fillOval(x,y, this.getProperties().get("Width").intValue(), this.getProperties().get("Height").intValue());
